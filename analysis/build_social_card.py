...
draw.text((50, 54), "OPEN EVENT RECONSTRUCTION", font=font(17, True), fill="#0b5266")
draw.multiline_text((50, 103), "Bhote Koshi-\nTrishuli flood", font=font(48, True), fill="#131c25", spacing=4)
draw.multiline_text(
    (50, 238),
    "Source failure, gauge blackout,\nand the observations that can\ndistinguish the flood cascade.",
    font=font(23),
    fill="#3b4956",
    spacing=8,
)
draw.rectangle((50, 375, 457, 456), fill="#f2e3c6")
draw.text((68, 387), "3,838 M ENDPOINT RELIEF", font=font(16, True), fill="#6f480c")
draw.text((68, 420), "GAUGE PEAK UNOBSERVED", font=font(15, True), fill="#6f480c")
draw.text((50, 490), "Ashish Dutta  |  Geospatial researcher", font=font(18, True), fill="#131c25")
draw.text((50, 523), "Version 0.3  |  26 August 2026", font=font(16), fill="#697785")
...
draw.text(
    (535, 605),
    "EVENT EVIDENCE  |  USGS  |  Nepal DHM  |  Copernicus DEM",
    font=font(12),
    fill="#f8fafb",
)

...
| `s2_prepost.py` | Public-facing pre/post composite with a zoomed readable reach and same-scale width summary. One stretch is computed across both dates; a per-date stretch can manufacture apparent change. |
